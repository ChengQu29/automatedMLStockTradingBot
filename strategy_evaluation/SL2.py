...
class StrategyLearner(object):
    ...
    def add_evidence(self, symbol="IBM", \
        ...
        stock_older_days = 45
        symbols = [symbol]
        prices, unused_a, unused_b = indicators2.price_sma(start_date=(sd - dt.timedelta(days=stock_older_days)),
        ...
        rsi = indicators2.rsi(start_date=(sd - dt.timedelta(days=stock_older_days)), end_date=ed, symbols=symbols)
        mfi = indicators2.mfi(start_date=(sd - dt.timedelta(days=stock_older_days)), end_date=ed, symbols=symbols)
        vix = indicators2.vix(start_date=sd, end_date=ed, symbols=symbols)
        rsi.columns = ['RSI']
        mfi.columns = ['MFI']
        vix.columns = ['VIX']
    ...
    def testPolicy(self, symbol="IBM", \
        ...
        # print '=========Y_in=======\n', self.y_nparray
        y_df = pd.DataFrame(data=Ytest, index=date_index, columns=['Ytest'])
